...
var WIDTH, HEIGHT, canvas, con, g, rint=100, pxs=[];

$(document).ready(function(){
	WIDTH = window.innerWidth;
	HEIGHT = window.innerHeight;
	$('#container').width(WIDTH).height(HEIGHT);
	canvas = document.getElementById('BODY-BACKGROUND');
...
function Circle() {
	this.s = {ttl:650000, xmax:3, ymax:2, rmax:400, rmin:200, rt:1, xdef:960, ydef:540, xdrift:2, ydrift: 2, random:true, blink:true};

	// fill vars
	var crFill = [
	['rgba(125,168,50,0)', 'rgba(125,168,50,1)'],
	['rgba(138,186,55,0)','rgba(138,186,55,1)'],
	['rgba(155,209,62,0)','rgba(155,209,62,1)'],
	['rgba(144,194,58,0)','rgba(144,194,58,1)']
				];
