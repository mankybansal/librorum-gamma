  ...
  text-transform: capitalize; 
	...
	<div class="content">
		...
		<div class="SPACER-15"></div>
			<text style="font-size: 45px;">Registrations Haven't Begun</text><br>
			<text style="font-size: 25px;">Come back on the 4th of March, <br>We'll be starting registrations then!</text><br>
